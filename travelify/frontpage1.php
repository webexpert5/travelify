<?php    
/*
Template name:Frontpage1
*/
include"headerland1.php";
?>
...
<!---htop-->
<div class="hright">
<?php //if ( !function_exists('dynamic_sidebar')    || !dynamic_sidebar('contact1') ) : ?>
<?php //endif; ?>
<div class="sform">
...
<?php if ( !function_exists('dynamic_sidebar')    || !dynamic_sidebar('testimonial1') ) : ?>
<?php endif; ?> 
</div>
<!--testimonial-->
<div class="cleft">
<?php if ( !function_exists('dynamic_sidebar')    || !dynamic_sidebar('cleft') ) : ?>
<?php endif; ?> 
