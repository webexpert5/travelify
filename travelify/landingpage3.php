<?php    
/*
Template name:Landing-Page3
*/
include"header-landing-page3.php";
?>
...
<?php if ( !function_exists('dynamic_sidebar')    || !dynamic_sidebar('cright3') ) : ?>
<?php endif; ?> 
</div>
<!--cleft-->
...
<?php if ( !function_exists('dynamic_sidebar')    || !dynamic_sidebar('cright2') ) : ?>
<?php endif; ?> 
